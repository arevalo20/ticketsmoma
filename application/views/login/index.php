    ...
    <div class="child">
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12">
              <img src="<?= base_url('assets/img/logo.png') ?>" alt="img login" class="img-log-tickets" style="height:200px;">
            </div>
          </div><!-- -row -->

          <div class="row">
            <div class="col-12 mx-auto text-center">
              <h3 class="titulo-tickets">Tickets de soporte</h3>
          ...
          <div class="row pt-2">
            <div class="col-12 mx-auto text-center">
              <button id="btn_login" type="submit" class="btn btn-default" data-toggle="tooltip" data-placement="left" title="">
                Iniciar sesión
              </button>
            </div><!-- .col-6 -->
          </div><!-- row -->
