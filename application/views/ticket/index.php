<div class="container">
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-4 col-sm-4 col-md-2 col-lg-2">
          <label>&nbsp;</label>
          <button id="btn_reporte_mes" type="submit" class="btn btn-secondary btn-block btn-lg"> Reporte </button>
        </div><!-- .col-lg-2 -->
      </div><!-- row -->
    </div><!-- .form-group -->
    <?= form_close() ?>
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-2">
      <a class="btn btn-default btn-block" href="<?= base_url('ticket/nuevo') ?>"><i class="fa fa-plus" aria-hidden="true"></i> NUEVO</a>
...
<script type="text/javascript" src="<?= base_url('assets/js/tickets/reportes.js') ?>"></script>